### In this task, we were asked to create an electrical circuit that can initiate a movement for two motors using H brage l298 and create a code to program this circuit.
